...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <div class="password-container">
                <input type="password" id="password" name="pass" required placeholder="Enter your password" required maxlength="20"  class="box" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"  oninput="this.value = this.value.replace(/\s/g, '')">   
